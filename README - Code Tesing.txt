...
UPDATE method
	Copy and paste the following command into CMD after starting the server:
		curl -X PUT http://localhost:3000/api/recipes/1 -H "Content-Type: application/json" -d "{\"name\":\"Updated Strawberry Pie\",\"ingredients\":[\"strawberries\",\"sugar\",\"flour\"],\"instructions\":[\"Mix ingredients\",\"Bake for 45 minutes\"]}"
